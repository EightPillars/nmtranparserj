...
$TABLE  ID TIME TRT AMT RATE DAY CMT MDV ICL IV1 IQ IV2 CAVG VISI POP PRED RES WRES DV IPRED IRES IWRES Y NOAPPEND NOPRINT FILE=sdtab

$TABLE  ID MTT GAM BASE BASE1 KTR ETA_MTT ETA_GAM ETA_BASE ETA_BASE1 ETA_KDEP ETA_SLOPE1 ETA_SLOPE2 NOAPPEND NOPRINT FILE=patab

$TABLE  ID TRT DAY ICL IV1 IQ IV2 CAVG VISI POP NOAPPEND NOPRINT FILE=cotab
