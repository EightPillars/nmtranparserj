...
;@MCL_start_IGNORE
;@MCL_"      LNVEGF_obs   : {type=continuous, error=combinedError2log(proportional=RUV_VEGF_PROP, f=VEGF),prediction=VEGF, eps=eps_RUV_EPS1} 
;@MCL_"      LNVEGFR2_obs : {type=continuous, error=combinedError2log(additive=RUV_VEGFR2_ADD, proportional=RUV_VEGFR2_PROP, f=VEGFR2), prediction=VEGFR2, eps=eps_RUV_EPS1}
;@MCL_"      LNVEGFR3_obs : {type=continuous, error=combinedError2log(proportional=RUV_VEGFR3_PROP, f=VEGFR3), prediction=VEGFR3, eps=eps_RUV_EPS1}
;@MCL_"      LNSKIT_obs   : {type=continuous, error=combinedError2log(proportional=RUV_SKIT_PROP, f=SKIT), prediction=SKIT, eps=eps_RUV_EPS1}
;@MCL_end_IGNORE
