...
;@MCL_"      P0 : {type=linear, trans=logit, pop=B0, fixEff={coeff=BETA, cov=CP}, ranEff= eta_PPV_EVENT}
;@MCL_"      P1 : {type=linear, trans=logit, pop=B1, fixEff={coeff=BETA, cov=CP}, ranEff= eta_PPV_EVENT}
;@MCL_"      P2 : {type=linear, trans=logit, pop=B2, fixEff={coeff=BETA, cov=CP}, ranEff= eta_PPV_EVENT}
